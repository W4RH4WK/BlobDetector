	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		if (data.getTarget() != null) {
			Core.putText(frame, data.getTarget().getDistance().toString(),
					new Point(20, 125), Core.FONT_HERSHEY_PLAIN, 1, new Scalar(
							255, 0, 0));
//			data.setTargetColor(BlobDetector.findXYColor(data.getImage(), data
//					.getTarget().getCenter(), mOpenCvCameraView.getWidth(),
//					mOpenCvCameraView.getHeight()));
